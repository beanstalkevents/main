    ...
    <div style={{ background: "var(--cream)" }}>
      ...
      <header style={{ background: "#233c36", paddingTop: "100px" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 pb-12">
          ...
          <h1 style={{ fontFamily: "'Iowan Old Style', 'Palatino Linotype', 'Book Antiqua', Palatino, Georgia, serif", fontWeight: 700, fontSize: "clamp(28px, 4vw, 52px)", color: "#fcf9ec", lineHeight: 1.05 }}>
            {title}
          </h1>
          {lastUpdated && (
