...
export default function NotFound() {
  return (
    <html lang="en">
      <body style={{ margin: 0, background: "#233c36", minHeight: "100vh", fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "200px 24px 80px" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontSize: "clamp(40px, 7vw, 80px)", color: "#fcf9ec", lineHeight: 1.0, margin: "0 0 16px" }}>
            Page not found
          </h1>
