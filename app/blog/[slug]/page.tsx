    ...
    <div style={{ background: "var(--cream)" }}>
      ...
      <header className="relative" style={{ background: "#233c36", paddingTop: "120px" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 pb-16">
          ...
          <h1 className="mb-4" style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "clamp(32px, 5vw, 64px)", color: "#fcf9ec", lineHeight: 1.05, maxWidth: "800px" }}>
            {post.title}
          </h1>
              ...
              .map((p) => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col gap-2">
                    <h3 style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "15px", color: "#fcf9ec", lineHeight: 1.2 }}>
                      {p.title}
                    </h3>
