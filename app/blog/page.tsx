    ...
    <div style={{ background: "var(--cream)" }}>
      ...
      <header className="relative" style={{ background: "#233c36", paddingTop: "120px" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 pb-16">
          ...
          <h1 className="mb-4" style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "clamp(40px, 6vw, 72px)", color: "#fcf9ec", lineHeight: 1.0 }}>
            The Beanstalk Blog
          </h1>
            ...
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col gap-3 flex-1">
                  ...
                  <h2 style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "18px", color: "#233c36", lineHeight: 1.2 }}>
                    {post.title}
                  </h2>
