    ...
    <div style={{ background: "var(--cream)" }}>
      ...
      <header id="hero" className="hero-bleed relative overflow-hidden" style={{ background: "#233c36", paddingBottom: 0 }}>
        ...
        <div className="max-w-content mx-auto px-6 md:px-12 pb-16 relative" style={{ zIndex: 2 }}>
          ...
          <h1 className="mb-5" style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "clamp(48px, 7vw, 92px)", color: "#fcf9ec", lineHeight: 1.0, maxWidth: "820px" }}>
        ...
        <div className="grid border-t relative" style={{ gridTemplateColumns: "repeat(4, 1fr)", borderColor: "rgba(255,255,255,0.08)", zIndex: 2 }}>
          {stats.map((s, i) => (
            <div key={i} className="px-8 py-7 flex flex-col gap-1" style={{ borderRight: i < stats.length - 1 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
              <strong style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "28px", color: "#cdf765", lineHeight: 1 }}>{s.value}</strong>
      ...
      <section id="about" style={{ background: "#fcf9ec" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 py-20 grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="mb-5" style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "clamp(26px, 3.5vw, 38px)", color: "#233c36", lineHeight: 1.15 }}>
              What is Beanstalk?
            </h2>
      ...
      <section id="expect" style={{ background: "#233c36" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 py-20">
          ...
          <h2 className="mb-12" style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "clamp(28px, 4vw, 44px)", color: "#fcf9ec", lineHeight: 1.1 }}>
            ...
            {whatToExpect.map((item) => (
              <div key={item.num} className="p-7 flex flex-col gap-3" style={{ background: "rgba(255,255,255,0.02)" }}>
                <div className="flex items-center gap-3">
                  <span className="text-xs font-semibold" style={{ color: "#cdf765", fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, }}>{item.num}</span>
                  <span className="text-2xl">{item.icon}</span>
                </div>
                <h3 style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "18px", color: "#fcf9ec" }}>{item.title}</h3>
      ...
      <section id="sponsor" style={{ background: "#233c36" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 py-20 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="mb-5" style={{ fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, fontSize: "clamp(28px, 4vw, 44px)", color: "#fcf9ec", lineHeight: 1.1 }}>
              Sponsor Beanstalk
            </h2>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={s.tier} className="flex items-center justify-between px-5 py-4" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div>
                  <div className="text-sm font-semibold mb-0.5" style={{ color: "#fcf9ec", fontFamily: "var(--font-serif), 'Iowan Old Style', Georgia, serif", fontWeight: 700, }}>{s.tier}</div>
