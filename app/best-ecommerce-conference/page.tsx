    ...
    <div style={{ background: "var(--cream)" }}>
      ...
      <header style={{ background: "#233c36", paddingTop: "120px" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 pb-16">
          ...
          <h1 className="mb-5" style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "clamp(40px, 6vw, 78px)", color: "#fcf9ec", lineHeight: 1.0, maxWidth: "840px" }}>
      ...
      <section style={{ background: "#fcf9ec" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 py-16" style={{ maxWidth: "760px" }}>
          ...
          <h2 className="mb-5" style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "clamp(26px, 3.5vw, 38px)", color: "#233c36" }}>
            ...
            <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
              ...
              <tbody>
                {comparisons.map((conf) => (
                  ...
                  >
                    <td className="py-4 px-4 font-semibold" style={{ color: conf.highlight ? "#cdf765" : "#fcf9ec", fontFamily: "NewSpirit, serif" }}>
          ...
          <div className="grid md:grid-cols-2 gap-px" style={{ border: "1px solid var(--beige)" }}>
            {reasons.map((r) => (
              <div key={r.num} className="p-7 flex flex-col gap-3" style={{ background: "#fcf9ec" }}>
                <span className="text-xs font-semibold" style={{ color: "#ba9e6e", fontFamily: "NewSpirit, serif" }}>{r.num}</span>
                <h3 style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "18px", color: "#233c36" }}>{r.title}</h3>
      ...
      <div style={{ background: "#cdf765" }}>
        <div className="max-w-content mx-auto px-6 md:px-12 py-12 flex flex-col gap-4">
          <p style={{ fontFamily: "NewSpirit, Georgia, serif", fontSize: "clamp(20px, 3vw, 32px)", color: "#233c36", lineHeight: 1.2, maxWidth: "700px" }}>
