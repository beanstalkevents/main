...
const H2 = ({ children }: { children: React.ReactNode }) => (
  <h2 style={{ fontFamily: "'Iowan Old Style', 'Palatino Linotype', 'Book Antiqua', Palatino, Georgia, serif", fontSize: "20px", color: "#233c36", marginTop: "32px", marginBottom: "8px", fontWeight: 700 }}>{children}</h2>
);
